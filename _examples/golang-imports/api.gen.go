// example-api-service v1.0.0 38441bf073e40f0103cdd97d1f3640a773ec97a3
// --
...
func WebRPCSchemaHash() string {
	return "38441bf073e40f0103cdd97d1f3640a773ec97a3"
}
...
func NewExampleAPIClient(addr string, client HTTPClient) ExampleAPIClient {
	prefix := serviceURL(addr, ExampleAPIPathPrefix)
	urls := [3]string{
		prefix + "Ping",
		prefix + "Status",
		prefix + "GetUsers",
...
func (s *exampleAPIService) Methods() []Method { return methodsFor(ServiceExampleAPI, s) }
...
func (s Server) Methods(opts *Options) []Method {
	...
	appendIf(s.ExampleAPI != nil, NewExampleAPIServer(s.ExampleAPI, opts))
	return out
}
...
const (
	ServiceExampleAPI Service = "ExampleAPI"
)
...
const WebrpcHeaderValue = "webrpc;gen-golang;example-api-service@v1.0.0"
