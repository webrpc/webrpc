/* eslint-disable */
// webrpc-sse-chat v1.0.0 3caf0112a9a3d8ec4471bdd1bc3625a2edb9cc38
// --
...
export const WebRPCSchemaHash = "3caf0112a9a3d8ec4471bdd1bc3625a2edb9cc38"
...
export interface Chat {
  sendMessage(args: SendMessageArgs, options?: WebrpcOptions): Promise<SendMessageReturn>
...
export class Chat implements Chat {
  ...
  private url(name: string): string {
    ...
    sendMessage = (args: SendMessageArgs, options?: WebrpcOptions): Promise<SendMessageReturn> => {
      return this.fetch(this.url('SendMessage'),createHTTPRequest(args, options)).then((res) => {
    ...
    subscribeMessages = (args: SubscribeMessagesArgs, options: WebrpcStreamOptions<SubscribeMessagesReturn>): Promise<void> => {
      return this.fetch(this.url('SubscribeMessages'),createHTTPRequest(args, options)).then(
      async(res) => {
...
export class EmptyUsernameError extends WebrpcError {
  constructor(
    ...
    code: number = 100,
    message: string = `Username can't be empty.`,
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
