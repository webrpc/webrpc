...
var (
	...
	ErrWebrpcStreamLost     = WebRPCError{Code: -8, Name: "WebrpcStreamLost", Message: "stream lost", HTTPStatus: 400}
	ErrWebrpcStreamFinished = WebRPCError{Code: -9, Name: "WebrpcStreamFinished", Message: "stream finished", HTTPStatus: 200, cause: io.EOF}
)

// Schema errors
var (
	ErrConnectionTooLong = WebRPCError{Code: 100, Name: "ConnectionTooLong", Message: "Connection too long. Terminated.", HTTPStatus: 400}
)
