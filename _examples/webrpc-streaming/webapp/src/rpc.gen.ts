/* eslint-disable */
// webrpc-sse-chat v1.0.0 8fdb95d57f6bec8a3fd44cb01ff5398d7a1bc853
// --
// Code generated by Webrpc-gen@v0.36.1-6-g93ac346 with typescript@v0.20.1 generator. DO NOT EDIT.
//
...
export const WebrpcSchemaHash = "8fdb95d57f6bec8a3fd44cb01ff5398d7a1bc853"
...
export class Chat implements ChatClient {
  ...
  subscribeMessages = (req: SubscribeMessagesRequest, options: WebrpcStreamOptions<SubscribeMessagesResponse>): WebrpcStreamController => {
    ...
    const _fetch = () => this.fetch(this.url('SubscribeMessages'),createHttpRequest(req, options.headers, abortSignal)
      ).then(async (res) => {
...
export const WebrpcHeaderValue = "webrpc@v0.36.1-6-g93ac346;gen-typescript@v0.20.1;webrpc-sse-chat@v1.0.0"
