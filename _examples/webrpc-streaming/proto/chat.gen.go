...
//
// webrpc-gen -schema=proto/chat.ridl -target=../../../gen-golang -pkg=proto -server -client -out=proto/chat.gen.go
package proto
...
const WebrpcHeaderValue = "webrpc@v0.29.0-16-g28d4195;gen-golang@unknown;webrpc-sse-chat@v1.0.0"
