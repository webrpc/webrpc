...
func NewChatClient(addr string, client HTTPClient) ChatClient {
	prefix := serviceURL(addr, ChatPathPrefix)
	urls := [2]string{
		prefix + "SendMessage",
...
func (s *chatService) Methods() []Method { return methodsFor(ServiceChat, s) }
...
const WebrpcHeaderValue = "webrpc;gen-golang;webrpc-sse-chat@v1.0.0"
