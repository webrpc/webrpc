...
func WebRPCSchemaHash() string {
	return "8fdb95d57f6bec8a3fd44cb01ff5398d7a1bc853"
}
...
func (s *chatService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/v1/Chat/SendMessage":
		handler = s.serveSendMessageJSON
	case "/v1/Chat/SubscribeMessages":
...
const WebrpcHeaderValue = "webrpc@v0.36.1-6-g93ac346;gen-golang@v0.27.1-0.20260315155603-1ff56724f5ce;webrpc-sse-chat@v1.0.0"
