...
// --
// Code generated by Webrpc-gen@v0.29.0-12-gad42eed with ../../../gen-typescript generator. DO NOT EDIT.
//
...
export const JsonEncode = <T = any>(typ: string, obj: T): string => {
...
export const JsonDecode = <T = any>(typ: string, data: string | any): T => {
  let parsed: any = data
...
export const WebrpcHeaderValue = "webrpc@v0.29.0-12-gad42eed;gen-typescript@unknown;node-ts@v1.0.0"
