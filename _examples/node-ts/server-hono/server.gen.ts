...
// --
// Code generated by Webrpc-gen@v0.28.2-4-gcd30baf with typescript@v0.20.2 generator. DO NOT EDIT.
//
// webrpc-gen -schema=service.ridl -target=typescript@v0.20.2 -server -out=./server-hono/server.gen.ts
...
export const WebrpcHeaderValue = "webrpc@v0.28.2-4-gcd30baf;gen-typescript@v0.20.2;node-ts@v1.0.0"
