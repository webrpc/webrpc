// hello-webrpc v1.0.0 65e6db812a0dc851feff2a1b9378127173184c30
// --
...
func WebRPCSchemaHash() string {
	return "65e6db812a0dc851feff2a1b9378127173184c30"
}
...
func NewExampleServer(svc Example) WebRPCServer {
...
func (s *exampleServer) serveGetUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.Example.GetUser(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *User `json:"user"`
	}{ret0}
...
func (s *exampleServer) serveFindUsers(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *exampleServer) serveFindUsersJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, ret1, err = s.Example.FindUsers(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *Page   `json:"page"`
