...
//
// webrpc-gen -schema=hello-api.ridl -target=typescript@v0.20.1 -client -out=./webapp/client.gen.ts
...
export const WebrpcHeaderValue = "webrpc@v0.28.2-4-gcd30baf;gen-typescript@v0.20.1;hello-webrpc@v1.0.0"
