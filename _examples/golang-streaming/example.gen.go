// golang-streaming v0.0.1 d1cc8ba3e3723388e4d6a13fd3121f0319e740b4
// --
...
func WebRPCSchemaHash() string {
	return "d1cc8ba3e3723388e4d6a13fd3121f0319e740b4"
}
...
type DownloadTwoStreamWriter interface {
	streamWriter
	Data(boop string, beep string) error
}

type DownloadTwoStreamReader interface {
	Read() (boop string, beep string, err error)
}
...
type ExampleServiceServer interface {
	...
	DownloadTwo(ctx context.Context, file string, stream DownloadTwoStreamWriter) error
}
...
func (s *exampleServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/ExampleService/Download":
		...
		return
	case "/rpc/ExampleService/DownloadTwo":
		s.serveDownloadTwo(ctx, w, r)
		return
	default:
...
func (s *exampleServiceServer) serveDownloadTwo(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "DownloadTwo")
	reqContent := struct {
		Arg0 string `json:"file"`
	}{}
	...
	streamWriter := &downloadTwoStreamWriter{sw}
	...
	func() {
		...
		err = s.service.DownloadTwo(ctx, reqContent.Arg0, streamWriter)
	}()
...
type downloadTwoStreamWriter struct {
	*serverStreamWriter
}

func (s *downloadTwoStreamWriter) Data(boop string, beep string) error {
	ret0 := boop
	ret1 := beep
...
type ExampleServiceClient interface {
	...
	DownloadTwo(ctx context.Context, file string) (DownloadTwoStreamReader, error)
}
...
func (c *exampleServiceClient) DownloadTwo(ctx context.Context, file string) (DownloadTwoStreamReader, error) {
	in := struct {
		Arg0 string `json:"file"`
	}{file}
	...
	return newClientDownloadTwoStreamReader(resp), nil
}
...
type clientDownloadTwoStreamReader struct {
	resp    *http.Response
	reader  io.Reader
	decoder *json.Decoder
}

func newClientDownloadTwoStreamReader(resp *http.Response) *clientDownloadTwoStreamReader {
	reader := httputil.NewChunkedReader(resp.Body)
	decoder := json.NewDecoder(reader)
	return &clientDownloadTwoStreamReader{
		resp: resp, reader: reader, decoder: decoder,
	}
}
