// golang-streaming v0.0.1 1a7f38e3283c15870062a5f6b625780fda68c9d3
// --
...
func WebRPCSchemaHash() string {
	return "1a7f38e3283c15870062a5f6b625780fda68c9d3"
}
...
func (c *exampleServiceClient) Download(ctx context.Context, file string) DownloadStreamReader {
	in := struct {
		Arg0 string `json:"file"`
	}{file}
	resp, err := clientRequest(ctx, c.client, c.urls[c.urls[2]], in, nil)
	if err != nil {
		return nil, err
	}
