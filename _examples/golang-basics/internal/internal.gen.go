// example v1.0.0 202456ad8ae28560f46886f31de7607e609324dc
// --
...
func WebRPCSchemaHash() string {
	return "202456ad8ae28560f46886f31de7607e609324dc"
}
...
func (c *exampleClient) DownloadAvatarWithMeta(ctx context.Context, userId uint64) (*File, uint64, string, error) {
	...
	resp, err := doHTTPRequestRaw(ctx, c.client, c.urls[5], in, nil)
	if err != nil {
		if resp != nil {
			resp.Body.Close()
		}
...
func (s Server) Methods(opts *Options) []Method {
	...
	appendIf(s.Admin != nil, NewAdminServer(s.Admin, opts))
	return out
}
