// example v0.0.1 c427b6669f5b34f9df04ca6a5f9c384899135572
// --
...
var methods = map[string]method{
	...
	"/rpc/Example/GetIntents": {
		name:        "GetIntents",
		service:     "Example",
		annotations: map[string]string{"public": ""},
	},
	"/rpc/Example/CountIntents": {
		name:        "CountIntents",
		service:     "Example",
		annotations: map[string]string{"public": ""},
	},
...
func (s *exampleServer) serveGetUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := struct {
		Arg0 *GetUserRequest `json:"getUserRequest"`
	}{}
	...
	// Call service method implementation.
	ret0, err := s.Example.GetUser(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 *GetUserResponse `json:"getUserResponse"`
	}{ret0}
	respBody, err := json.Marshal(respPayload)
	if err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCausef("failed to marshal json response: %w", err))
...
func (s *exampleServer) serveGetUserV2JSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.Example.GetUserV2(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *exampleServer) serveFindUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, ret1, err := s.Example.FindUser(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *exampleServer) serveGetIntentsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetIntents")

	// Call service method implementation.
	ret0, err := s.Example.GetIntents(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *exampleServer) serveCountIntentsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.Example.CountIntents(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
