...
require (
	...
	github.com/webrpc/gen-golang v0.28.1
	github.com/webrpc/gen-javascript v0.15.0
	github.com/webrpc/gen-kotlin v0.3.0
	github.com/webrpc/gen-openapi v0.18.0
	github.com/webrpc/gen-typescript v0.26.0
