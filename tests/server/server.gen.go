...
// --
// Code generated by webrpc-gen@v0.11.x-dev with github.com/webrpc/gen-golang@tags/errors generator. DO NOT EDIT.
//
// webrpc-gen -schema=./schema/test.ridl -target=github.com/webrpc/gen-golang@tags/errors -pkg=server -server -out=./server/server.gen.go
package server
