...
func (s *testApiService) serveUploadFileMultipart(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	var formErr error
	reqPayload.Arg1, formErr = formFile(r.MultipartForm, "data")
	if formErr != nil {
...
func (s *testApiService) serveUploadFilesMultipart(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	var formErr error
	reqPayload.Arg0, formErr = formFiles(r.MultipartForm, "files")
	if formErr != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(formErr))
		return
	}
...
func (s *testApiService) serveEchoFileMultipart(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	var formErr error
	reqPayload.Arg0, formErr = formFile(r.MultipartForm, "data")
	if formErr != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(formErr))
		return
	}
