// Test v0.0.1 b08c9b28bb762641278e49c5f7f00685ebaf2fb9
// --
// Code generated by webrpc-gen@v0.8.x-dev with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=./schema/api.ridl -target=golang -pkg=server -server -out=./server/server.gen.go
package server
...
func WebRPCSchemaHash() string {
	return "b08c9b28bb762641278e49c5f7f00685ebaf2fb9"
}
...
type complexApiServer struct {
	ComplexApi
}

func NewComplexApiServer(svc ComplexApi) WebRPCServer {
	return &complexApiServer{
		ComplexApi: svc,
	}
}

func (s *complexApiServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "ComplexApi")
	...
	switch r.URL.Path {
	case "/rpc/ComplexApi/GetComplex":
		s.serveGetComplex(ctx, w, r)
		return
	case "/rpc/ComplexApi/SendComplex":
...
func (s *complexApiServer) serveGetComplex(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *complexApiServer) serveGetComplexJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetComplex")

	// Call service method
	var ret0 *ComplexType
	func() {
		defer func() {
		...
		ret0, err = s.ComplexApi.GetComplex(ctx)
	}()
	respContent := struct {
...
func (s *complexApiServer) serveSendComplex(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *complexApiServer) serveSendComplexJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		err = s.ComplexApi.SendComplex(ctx, reqContent.Arg0)
	}()
...
func NewErrorApiServer(svc ErrorApi) WebRPCServer {
	return &errorApiServer{
		ErrorApi: svc,
	}
}

func (s *errorApiServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "ErrorApi")
...
func (s *errorApiServer) serveGetError(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *errorApiServer) serveGetErrorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.ErrorApi.GetError(ctx)
	}()
	respContent := struct {
