// Test v1.0.0 9ab2751a8c289cd8ab97df413110467a09a92603
// --
...
func WebRPCSchemaHash() string {
	return "9ab2751a8c289cd8ab97df413110467a09a92603"
}
...
type TestApiServer interface {
	...
	DownloadFileWithMeta(ctx context.Context, name string) (*File, uint64, string, error)
...
func (s *testApiService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/TestApi/DownloadFileWithMeta":
		handler = s.serveDownloadFileWithMetaJSON
...
func (s *testApiService) serveDownloadFileWithMetaJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "DownloadFileWithMeta")
	...
	// Call service method implementation.
	ret0, ret1, ret2, err := s.TestApiServer.DownloadFileWithMeta(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	if ret0 == nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCausef("method DownloadFileWithMeta returned a nil file"))
		return
	}
	metaPayload := struct {
		Ret1 uint64 `json:"size"`
		Ret2 string `json:"etag"`
	}{ret1, ret2}
...
var methods = map[string]*method{
	...
	"/rpc/TestApi/DownloadFileWithMeta": {
		name:        "DownloadFileWithMeta",
		service:     "TestApi",
		annotations: map[string]string{},
	},
